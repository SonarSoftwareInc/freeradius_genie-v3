        ...
        while ($ipAddress == null || filter_var($ipAddress, FILTER_VALIDATE_IP) === false)
        {
            ...
            elseif ($ipAddress === 'd')
            {
                ...
                $ipAddresses = ['20.221.112.37', '20.221.114.13', '52.158.209.86', 
                     // 20.15.246.160/28
                    '20.15.246.160', '20.15.246.161', '20.15.246.162', '20.15.246.163', 
                    '20.15.246.164', '20.15.246.165', '20.15.246.166', '20.15.246.167',
                    '20.15.246.168', '20.15.246.169', '20.15.246.170 ', '20.15.246.171',
                    '20.15.246.172', '20.15.246.173', '20.15.246.174', '20.15.246.175',
                    // 20.84.143.0/28 
                    '20.84.143.0', '20.84.143.1', '20.84.143.2', '20.84.143.3',
                    '20.84.143.4', '20.84.143.5', '20.84.143.6', '20.84.143.7',
                    '20.84.143.8', '20.84.143.9', '20.84.143.10', '20.84.143.11',
                    '20.84.143.12', '20.84.143.13', '20.84.143.14', '20.84.143.15'
                    ];
                break;
            }
